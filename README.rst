...
.. image:: https://pypip.in/download/ckanext-elaine_theme/badge.svg
    :target: https://pypi.python.org/pypi//ckanext-elaine_theme/
    :alt: Downloads

.. image:: https://pypip.in/version/ckanext-elaine_theme/badge.svg
    :target: https://pypi.python.org/pypi/ckanext-elaine_theme/
    :alt: Latest Version

.. image:: https://pypip.in/py_versions/ckanext-elaine_theme/badge.svg
    :target: https://pypi.python.org/pypi/ckanext-elaine_theme/
    :alt: Supported Python versions

.. image:: https://pypip.in/status/ckanext-elaine_theme/badge.svg
    :target: https://pypi.python.org/pypi/ckanext-elaine_theme/
    :alt: Development Status

.. image:: https://pypip.in/license/ckanext-elaine_theme/badge.svg
    :target: https://pypi.python.org/pypi/ckanext-elaine_theme/
    :alt: License
...
---------------------------------
Registering ckanext-elaine_theme on PyPI
---------------------------------

ckanext-elaine_theme should be availabe on PyPI as
https://pypi.python.org/pypi/ckanext-elaine_theme. If that link doesn't work, then
...
----------------------------------------
Releasing a New Version of ckanext-elaine_theme
----------------------------------------

ckanext-elaine_theme is availabe on PyPI as https://pypi.python.org/pypi/ckanext-elaine_theme.
